...
export default function Home() {
  ...
  const dummyVideos = [
    { id: "ZnHdkK4EhuE", title: "Nigeria Is Not One Nation; Trying to Make Us One Is Never Going to Work" },
    { id: "s5iDJZ__2kA", title: "June 12: Babangida Should Hide in Shame" },
    { id: "tXN69RN9EF4", title: "Political Restructuring and Constitutional Review" },
    { id: "Wp6ouX2Su7g", title: "Dr. Akin Fapohunda Speaks on National Governance" },
    { id: "DsqoDhXQfkE", title: "State of the Nation: Insights from Akin Fapohunda" },
    { id: "YW0E_rAbIl4", title: "Perspectives on Nigerian Democracy" }
  ];
